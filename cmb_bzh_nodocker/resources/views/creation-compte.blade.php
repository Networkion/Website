...
<div class="container-connexion">
        <div class="card-gris-center">
            ...
            <i class="text-discret">email</i>
            <input class="input-recherche" placeholder="Saisissez votre email"/>
            <i class="text-discret">mot de passe</i>
            <input class="input-recherche" placeholder="Saisissez votre mot de passe"/>
            <i class="text-discret">numéro de carte</i>
            <input class="input-recherche" placeholder="Saisissez votre numéro de carte"/>
            <p><input type="checkbox"/> Se Souvenir De Moi</p>
            <h3><i>Vous avez déjà un compte ?</i></h3>
